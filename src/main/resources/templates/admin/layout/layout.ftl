          ...
          <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <img src="https://gitee.com/uploads/78/559378_whoismy8023.png?1482721399" class="user-image" alt="User Image">
                      <span class="hidden-xs">Alexander Pierce</span>
                  </a>
                  <ul class="dropdown-menu">
                      <!-- User image -->
                      <li class="user-header">
                          <img src="https://gitee.com/uploads/78/559378_whoismy8023.png?1482721399" class="img-circle" alt="User Image">
